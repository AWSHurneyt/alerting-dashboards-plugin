...
export const getDataSources = (monitor, localClusterName) => {
  ...
  console.info(`hurneyt getDataSources::monitorType = ${JSON.stringify(monitorType, null, 4)}`);
  console.info(`hurneyt getDataSources::monitor = ${JSON.stringify(monitor, null, 4)}`);
  let dataSources;
  switch (monitorType) {
  ...
  console.info(`hurneyt getDataSources::output = ${JSON.stringify(dataSources, null, 4)}`);
