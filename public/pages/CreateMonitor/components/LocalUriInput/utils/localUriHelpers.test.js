...
describe('localUriHelpers', () => {
  describe('buildLocalUriRequest', () => {
    ...
    describe('when api_type is blank', () => {
      test('path is provided', () => {
        const path = API_TYPES_PATHS[API_TYPES.CLUSTER_HEALTH].withoutPathParams;
        const values = {
          uri: {
            api_type: '',
            path: path,
        ...
        const expectedResult = {
          uri: {
            api_type: API_TYPES.CLUSTER_HEALTH,
            path: path,
            path_params: '',
  ...
  describe('getApiTypesRequiringPathParams', () => {
    const expectedApiTypes = [API_TYPES.CAT_SNAPSHOTS];
