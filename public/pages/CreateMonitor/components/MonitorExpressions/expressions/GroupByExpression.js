...
import { GROUP_BY_TOOLTIP_TEXT } from '../../../containers/CreateMonitor/utils/constants';
import IconToolTip from '../../../../../components/IconToolTip';

const GroupByExpression = ({ formik: { values }, errors, arrayHelpers, dataTypes, flyoutMode }) => {
  ...
  return (
    <div id="groupBy">
      ...
      {values.groupBy.map((groupByItem, index) => (
